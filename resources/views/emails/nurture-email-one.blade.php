                    ...
                    <tr>
                        <td style="padding: 24px;">
                            ...
                            <p style="margin: 0 0 16px; font-size: 14px; line-height: 1.6;">
                                We wanted to follow up on your recent <strong>{{ $lead->practice_area }}</strong> enquiry.
                                If you still need advice, we're here to help.
                            </p>

                            <p style="margin: 0 0 24px; font-size: 14px; line-height: 1.6;">
                                Book a free initial consultation with one of our solicitors at a time that suits you.
                            </p>
