...
<head>
    <meta charset="utf-8">
    <title>One last thing before we close your enquiry</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 24px;">
                            ...
                            <p style="margin: 0 0 16px; font-size: 14px; line-height: 1.6;">
                                We haven't heard back from you about your <strong>{{ $lead->practice_area }}</strong>
                                enquiry, so we'll be closing it on our end for now.
                            </p>

                            <p style="margin: 0 0 24px; font-size: 14px; line-height: 1.6;">
                                If you'd still like to speak to us, you're welcome to book a consultation at any time.
                            </p>
